...
public class LemmikkirekisteriDB
{
    ...
    public LemmikkirekisteriDB()
    {
        ...
        command1.CommandText = "CREATE TABLE Omistajat (id INTEGER PRIMARY KEY, nimi TEXT, puhelinnumero VARCHAR(20))";
        command1.ExecuteNonQuery();

        // Luodaan taulu Lemmikit sarakkeet id, omistaja_id, nimi, laji.
        var command2 = connection.CreateCommand();
        command2.CommandText = "CREATE TABLE Lemmikit (id INTEGER PRIMARY KEY, omistaja_id INTEGER FOREIGN KEY (omistaja_id) (Omistajat(id)), nimi TEXT, laji TEXT)";
